<div class="max-w-2xl mx-auto mt-10 p-8 bg-white shadow-md rounded">
    ...
    <h2 class="text-2xl font-bold mb-6 text-gray-800 text-center">Ajouter un hôtel</h2>
    ...
    <div class="mt-4">
        <x-input label="Email" type="email" wire:model="email" placeholder="Ex: exemple@exemple.com"
            class="w-[95%] mx-auto bg-white text-gray-900 border-gray-300 focus:ring-blue-500" />
    </div>
    ...
    <div class="mt-4">
        <x-select label="Ville" wire:model="city_id"
            class="w-[95%] mx-auto bg-white text-gray-900 border-gray-300 focus:ring-blue-500">
    ...
    <input wire:model="slug" hidden />

    <div class="mt-6">
        <button wire:click="register"
    class="w-[95%] mx-auto text-center bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-6 rounded">
    Ajouter l'hôtel
</button>
