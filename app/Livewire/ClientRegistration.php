    ...
    public function exportToPdf()
{
    ...
    $data = $this->only([
        'identity_number', 'origin', 'Last_name', 'First_name', 'gender_id',
        'date_naissance', 'lieu_naissance', 'nationalite', 'adresse',
        'telephone', 'email', 'father_name', 'mother_name', 'profession',
        'children_under_15', 'date_arrivee', 'date_depart', 'motif',
        'lieu_sejour', 'type_chambre', 'nombre_personnes',
        'arrival_country_date', 'departure_country_date', 'next_destination',
        'date_enregistrement', 'heure_enregistrement', 'numero_enregistrement',
        'signature', 'identity_image', 'selfi'
    ]);
