<div class="max-w-2xl mx-auto mt-10 p-8 bg-white shadow-md rounded">
    ...
    <p class="text-center text-sm text-gray-500 -mt-4 mb-6">Mettez à jour les informations de {{ $user->name }}</p>
    ...
    <div class="mt-4">
        <x-select label="Statut" wire:model.defer="status"
            class="w-[95%] mx-auto bg-white text-gray-900 border-gray-300 focus:ring-blue-500">
...
">
    ...
    <div class="mt-6 border-t border-gray-200 pt-4">
        <p class="text-sm text-gray-500 ml-2 mb-3">Laissez les champs vides pour ne pas modifier le mot de passe.</p>

        <div class="mt-4">
            <x-input label="Nouveau Mot de Passe" type="password" wire:model.defer="password"
        ...
        <div class="mt-4">
            <x-input label="Confirmer Nouveau Mot de Passe" type="password" wire:model.defer="password_confirmation"
